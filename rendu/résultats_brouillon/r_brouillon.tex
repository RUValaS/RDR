...
%	\end{figure}
	...
	On effectue 6 réalisations de Kalman sur 8 instants temporels en introduisant une erreur sur la position des antennes. On effectue cette opération pour plusieurs erreurs et on peut observer les erreurs $\fnorm{\varepsilon_K}$ et $\fnorm{\varepsilon_{\widehat{x}}}$ :
	...
	\begin{figure}[H]
		\centering
		\includesvg[width=0.7\linewidth]{Perfs/x_fK}
